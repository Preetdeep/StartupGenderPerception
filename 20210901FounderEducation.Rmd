...
output: 
  bookdown::pdf_document2:
    toc: no
abstract: "I look at the perception of educational background of startup founders. AAAAAAAAA EdIT HERE. Perception differences across gender(negative), age(positive), region(positive), and startup experience(postiive) are analysed based on the traits of the founders. This has implication for investors, employees and customers. We make policy recommendations with regard to sensitization and encouraging gender diversity."
...
library(ggplot2)
###Copy paste code for the first one
##One for Success for CASE 1 and CASE 2
##One for Funding for CASE 1 and CASE 2
##One for Abandonment for CASE 1 and CASE 2
```


```{r first2, echo=FALSE,fig=TRUE, fig.width=7,fig.height=4, fig.cap="\\label{fig:boxsuccess12th}This box plot shows the probability of success as estimated for male and female founders educated till class 12."}
library(ggplot2)
vis12<-ggplot(mergedtest[mergedtest$Name=="Female12th" | mergedtest$Name=="Male12th",],aes(Name,Success))
vis12<-vis12+geom_boxplot()
vis12<-vis12+labs(title ="Boxplot of estimated success probability.",x="Category",y="Probability of Success" ) # size
print(vis12)
...
In figure \@ref(fig:boxsuccess12th) we can see how people perceive the probability of success for a startup founded by males versus that founded by females, when they have only completed schooling. While the mean value of success for a startup founded by school educated females at `r round(mean(Female12th$Success),2)` is higher than that of males at the same educated level at `r round(mean(Male12th$Success),2)`   , the difference is not statistically significant at a p-value of `r round(t.test(Female12th$Success,Male12th$Success)$p.value,2)`.

```{r second2, echo=FALSE,fig=TRUE, fig.width=7,fig.height=4, fig.cap="\\label{fig:boxsuccessIITIIM}This box plot shows the probability of success as estimated for highly educated male and female founders."}
...
Call out on Success. 
Call out on Funding 
Call out on Abandonment 


\subsection{T Test results}

\subsubsection{Success}
The mean for CASE 1 is A. The mean for CASE 2 is B. The p value is XXXX. This means that the difference in the perception of success for startups where founders are CASE 1 and CASE 2 is NOT statistically significant.
\subsubsection{Funding}
The mean for CASE 1 is A. The mean for CASE 2 is B. The p value is XXXX. This means that the difference in the perception of success for startups where founders are CASE 1 and CASE 2 is NOT statistically significant.
\subsubsection{Abandonment}
The mean for CASE 1 is A. The mean for CASE 2 is B. The p value is XXXX. This means that the difference in the perception of success for startups where founders are CASE 1 and CASE 2 is NOT statistically significant.
...
How respondents from each gender perceive the founders under each case.
\subsubsection{CASE 1 Success}
Male respondents rate the probability of success of a startup led by CASE 1 founders was A.
Female respondents rate the probability of success of a startup led by CASE 1 founders was B.
The p value is XXX. This means that there is a difference between the perception of CASE 1 startups between evaluating males and females. 


\subsubsection{CASE 1 Funding}
Male respondents rate the probability of success of a startup led by CASE 1 founders was A.
Female respondents rate the probability of success of a startup led by CASE 1 founders was B.
The p value is XXX. This means that there is a difference between the perception of CASE 1 startups between evaluating males and females. 

\subsubsection{CASE 1 Abandonment}
Male respondents rate the probability of success of a startup led by CASE 1 founders was A.
Female respondents rate the probability of success of a startup led by CASE 1 founders was B.
The p value is XXX. This means that there is a difference between the perception of CASE 1 startups between evaluating males and females. 

\subsubsection{CASE 2 Success}
Male respondents rate the probability of success of a startup led by CASE 1 founders was A.
Female respondents rate the probability of success of a startup led by CASE 1 founders was B.
The p value is XXX. This means that there is a difference between the perception of CASE 1 startups between evaluating males and females. 


\subsubsection{CASE 2 Funding}
Male respondents rate the probability of success of a startup led by CASE 1 founders was A.
Female respondents rate the probability of success of a startup led by CASE 1 founders was B.
The p value is XXX. This means that there is a difference between the perception of CASE 1 startups between evaluating males and females. 

\subsubsection{CASE 2 Abandonment}
Male respondents rate the probability of success of a startup led by CASE 1 founders was A.
Female respondents rate the probability of success of a startup led by CASE 1 founders was B.
The p value is XXX. This means that there is a difference between the perception of CASE 1 startups between evaluating males and females. 
