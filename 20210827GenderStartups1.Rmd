...
\section{Method}
		...
		We modify the following details about the founders \begin{itemize}
			\item Education \begin{itemize}
				\item Low Education
				\item Technical Education
				\item Management Education
			\end{itemize}
			\item Government Connect\begin{itemize}
				\item Family in government service
				\item Ex-government service
			\end{itemize}
			\item Age\begin{itemize}
				\item Young
				\item Mid-age
				\item Old
			\end{itemize}
			\item Region \begin{itemize}
				...
				\item Tier II City
			\end{itemize}
			\item Startup Experience\begin{itemize}
				\item Founder\begin{itemize}
					\item Successful startup
					\item Failed startup
				\end{itemize}
